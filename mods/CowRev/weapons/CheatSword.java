...
public class CheatSword extends Item
{
private int weaponDamage;
private final EnumToolMaterial toolMaterial;

public CheatSword(int ID, EnumToolMaterial material, String name)
{
...
this.weaponDamage = 10000 + toolMaterial.getDamageVsEntity(); //How strong it is on enemies
setUnlocalizedName("CowRev:cheat");
...
{
list.add("10000 Damage");
list.add("This Sword is Creative Only");
}
}
