...
public EnderSword(int ID, EnumToolMaterial material, String name)
{
...
setUnlocalizedName("CowRev:endersword");
...
public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
{
    ...
    else
    {
        ...
        {
            par2World.spawnEntityInWorld(new EntityEnderball(par2World, par3EntityPlayer));
...
list.add(dura(stack));
list.add("Will Teleport You On Right Click");
}
}
