...
public class BlazeCow extends EntityBlaze
{
    ...
    public BlazeCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/blazecow.png";
    ...
    public void func_70844_e(boolean par1)
    {
        ...
        this.dataWatcher.updateObject(22, Byte.valueOf(b0));
    }
