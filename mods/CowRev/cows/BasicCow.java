...
public class BasicCow extends EntityAnimal
{
    public BasicCow(World par1World)
    {
        super(par1World);
     ...
     */
    public BasicCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new BasicCow(this.worldObj);
    }
