...
public class MilkaCow extends EntityCow
{
    public MilkaCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/milkacow.png";
     ...
     */
    public MilkaCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new MilkaCow(this.worldObj);
    }
