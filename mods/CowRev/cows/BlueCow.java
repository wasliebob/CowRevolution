...
public class BlueCow extends EntityCow
{
    public BlueCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/bluecow.png";
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(CowRev.blueleather.itemID, 1);
        }
     ...
     */
    public BlueCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new BlueCow(this.worldObj);
    }
