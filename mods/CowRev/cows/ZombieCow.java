...
public class ZombieCow extends EntityCow
{
    public ZombieCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/zombiecow.png";
     ...
     */
    public ZombieCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new ZombieCow(this.worldObj);
    }
