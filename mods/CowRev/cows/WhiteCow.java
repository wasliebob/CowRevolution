...
public class WhiteCow extends EntityCow
{
    public WhiteCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/whitecow.png";
    ...
    {
        return CowRev.whiteleather.itemID;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(CowRev.whiteleather.itemID, 1);
        }
        ...
        for (k = 0; k < j; ++k)
        {
            if (this.isBurning())
            {
                this.dropItem(CowRev.whitebeef.itemID, 1);
            }
            else
            {
                this.dropItem(CowRev.whitebeef.itemID, 1);
     ...
     */
    public WhiteCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new WhiteCow(this.worldObj);
    }
