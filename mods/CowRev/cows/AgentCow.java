...
public class AgentCow extends EntityCow
{
    public AgentCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/agentcow.png";
        ...
        this.addPotionEffect(new PotionEffect(Potion.invisibility.id, 9999));
    }
    ...
    {
        return CowRev.blueleather.itemID;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(CowRev.secretleather.itemID, 1);
        }
     ...
     */
    public AgentCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new AgentCow(this.worldObj);
    }
