...
public class CreeperCow extends EntityCreeper
{
    /**
    ...
    public CreeperCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/creepercow.png";
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, new AICreeper(this));
