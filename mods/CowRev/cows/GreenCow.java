...
public class GreenCow extends EntityCow
{
    public GreenCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/greencow.png";
    ...
    {
        return CowRev.greenleather.itemID;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(CowRev.greenleather.itemID, 1);
        }
        ...
        for (k = 0; k < j; ++k)
        {
            if (this.isBurning())
            {
                this.dropItem(CowRev.bluebeef.itemID, 1);
            }
            else
            {
                this.dropItem(CowRev.greenbeef.itemID, 1);
            }
        }
    }
     ...
     */
    public GreenCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new GreenCow(this.worldObj);
    }
