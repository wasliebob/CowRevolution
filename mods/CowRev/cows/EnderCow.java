...
public class EnderCow extends EntityEnderman
{
    ...
    public EnderCow(World par1World)
    {
        super(par1World);
        this.texture = "/mods/CowRev/textures/mobs/endercow.png";
        this.moveSpeed = 0.2F;
    ...
    {
        return CowRev.enderleather.itemID;
    }
    ...
    {
        this.dataWatcher.updateObject(23, Byte.valueOf((byte)(par1 & 255)));
    }
    ...
    {
        this.dataWatcher.updateObject(24, Byte.valueOf((byte)(par1 & 255)));
    }
    ...
    {
        this.dataWatcher.updateObject(25, Byte.valueOf((byte)(par1 ? 1 : 0)));
    }
