...
public CowGun(int ID, EnumToolMaterial material, String name)
{
...
setUnlocalizedName("CowRev:cgun");
...
public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
{
    ...
    else
    {
        ...
        {
            par2World.spawnEntityInWorld(new EntityCBullet(par2World, par3EntityPlayer));
